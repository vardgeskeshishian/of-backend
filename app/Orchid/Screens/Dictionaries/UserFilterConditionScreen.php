...
class UserFilterConditionScreen extends Screen
{
    private static string $tableName;

    public function __construct(public UserFilterCondition $model)
    {
    ...
    public function layout(): iterable
    {
        return [
            Layout::table(self::$tableName, [
                ...
                BaseTD::make('user', 'user')
                    ->render(fn(UserFilterCondition $model) => e($model->user?->name)),
