...
class CurrencyTypeScreen extends Screen
{
    private static string $tableName;

    public function __construct(public CurrencyType $model)
    {
    ...
    public function layout(): iterable
    {
        return [
            Layout::table(self::$tableName, [
                ...
                BaseTD::make('code', __('general.table.code')),
                BaseTD::make('ruble_exchange_rate', __('general.table.ruble_exchange_rate')),
            ]),
        ];
    }
}
